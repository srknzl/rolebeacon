...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("We cannot offer visa sponsorship.", "unavailable"),
        ("We don't offer sponsorship for this position.", "unavailable"),
        ("We don\u2019t offer sponsorship for this position.", "unavailable"),
        ("We do not offer visa sponsorship.", "unavailable"),
        ("We are not able to sponsor work permits.", "unavailable"),
        ("Sponsorship is not available for this role.", "unavailable"),
        ("This role is not eligible for visa sponsorship.", "unavailable"),
        ("We sponsor conferences and meetups you want to attend.", "unknown"),
        ("We do not offer relocation assistance for this role.", "unknown"),
        ("This role does not require sponsorship.", "unknown"),
